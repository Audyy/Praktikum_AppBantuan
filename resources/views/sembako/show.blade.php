                ...
                <form action="{{ route('sembako.store') }}" method="post">
                    ...
                    <div class="form-group row">
                        <label class="form-label col-sm-2">NIK
                            Penerima</label>
                        <div class="col-sm-4">
                            <input type="text" name="nik" placeholder="NIKPenerima" class="form-control" value="{{ $data->nik_kk }}" readonly>
                        </div>
                        <label class="form-label col-sm-2">Jenis
                            Bantuan</label>
                        <div class="col-sm-4">
                            <input type="text" name="jenis" placeholder="JenisBantuan" class="form-control" value="{{ $data->jenis_bantuan }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <a href="{{ route('sembako.index') }}" class="btn btn-danger">
                            BATAL</a>
                    </div </form>
            </div>
        </div><!-- akhir card -->
